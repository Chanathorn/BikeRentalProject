...
<head>
    ...
    <style>
        ...
        .fb {
            padding:10px; text-align:center; font-size:15px; font-family:Arial,Helvetica;
...
<body>
    <table class="bg">
        <tr><td>
                <font size="5" class="text-left"><b>&nbsp;&nbsp;ชื่อ-นามสกุล: {{$Member->name_member}} {{$Member->lastname_member}} </b></font><br>
                <font size="5" class="text-left"><b>&nbsp;&nbsp;รหัสสมาชิก: {{('M').$Member->member_id}} </b></font><br> 
                <font size="5" class="text-left"><b>&nbsp;&nbsp;วันที่ออกบัตร: {{$Member->created_at->toDateString()}}</b></font><br> 
