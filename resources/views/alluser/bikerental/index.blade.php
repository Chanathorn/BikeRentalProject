...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{url('admin/dashboard/bikerental/search')}}" method="POST" role="search">
                {{ csrf_field() }}
                <div class="input-group">
                    <input type="text" class="form-control" name="q" placeholder="Search หาค่า สถานะเช่า = 99999 ,สถานะคืน =99998,สถานะหาย =99997">
            ...
            @if(isset($details))
            <div align="right">@include('alluser/bikerental/create')</div>
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{action("BikeRentalsController@destroy", ":id")}}';
