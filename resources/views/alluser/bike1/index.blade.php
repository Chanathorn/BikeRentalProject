...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{url('home/bike/search')}}" method="POST" role="search">
                {{ csrf_field() }}
            ...
            @if(isset($details))
            <div align="right">@include('alluser/bike1/create')</div>
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>@include('alluser/bike1/edit')</td>
                    @else
...
<script type="text/javascript">
    function deleteData(id) {
        var id = id;
        var url = '{{ action("BikeGeneralController@destroy", ":id") }}';
