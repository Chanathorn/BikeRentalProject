...
<div class="modal fade" id="myModalpdf{{$row['return_id']}}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div id="popupinfo">
                <form method="POST" action="{{ action('PDFGeneralController@pdfreturn',$row['return_id'])}}" target="_blank" id="centerframediv">
                    <br>
                        ...
                        <div class="card" >
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <h6>
                                        <p class="text-left"> รหัสการคืน: {{('R').$row['return_id']}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; วันที่ {{date('Y-m-d')}} </p>
                                    </h6>
                                    <h6>
                                        <p class="text-left"> รหัสการเช่า: {{('HI').$row['rental_id']}}  </p>
                                    </h6>
                                    <h6>
                                    ...
                                    <h6>
                                        <p class="text-left"> วันที่คืน: <?php $date = date_create($row['return_date']);
                                     echo date_format($date, "d/m/Y"); ?> </p>
                                    </h6>
                                    <br>
                                        <table id="tablepdf">
                                            ...
                                            <tr>
                                                ...
                                                <td><b>{{$row['bikerentals']['price']}}</b></td>
                                            </tr>
                                        </table>
                                        <br>
                                        <h6>
                                        <p class="text-right"> ค่าปรับ&nbsp;&nbsp;&nbsp;&nbsp;{{$row['fine']}} บาท</p>
                                         </h6>
                                        <h6>
