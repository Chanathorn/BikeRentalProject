...
<body>
                                    ...
                                    <br>
                                    <font size="5" class="text-left"><b> รหัสการคืน: {{('HI').$Bikereturn->return_id}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; วันที่ {{date('Y-m-d')}} </b></font><br>
                                    <font size="5" class="text-left"><b> รหัสการเช่า: {{('R').$Bikerental->rental_id}}</b></font><br>
                                    ...
                                    <font size="5" class="text-left"><b> วันที่คืน: {{$Bikereturn->return_date}}</b></font><br>
                                <table>
                               ...
                               <font size="5"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ค่าปรับ {{$Bikereturn->fine}} บาท</b></font><br>
