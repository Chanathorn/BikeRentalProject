...
class BikeReturnsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        //dd($users);
        return view('alluser\bikereturn.index', compact('details'));
    }
    ...
    {
        return view('alluser\bikereturn.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('alluser\bikereturn.edit', compact('user', 'id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $his->datetime = date('Y-m-d H:i:s');
        $his->save();
        return redirect()->route('bikereturn.index')->with('success', 'อัพเดทเรียบร้อย');
    }
    ...
    public function destroy($id)
    {
        ...
        //dd($user);
        $user->delete();
        return redirect()->route('bikereturn.index')->with('success', 'ลบข้อมูลเรียบร้อย');
    }
}
