...
class BikeRentalsController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        //dd($details);
        return view('alluser\bikerental.index', compact('details'));
    }
    ...
    public function create($id)
    {
        $user = Bike::find($id);
        //dd($user);
        return view('alluser\bikerental.create', compact('$user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $status->status_id = 2;
        $status->save();
        return redirect()->route('bikerental.index')->with('success', 'บันทึกข้อมูลเรียบร้อย');
    }
    ...
    public function edit($id)
    {
        ...
        return view('alluser\bikerental.edit', compact('user', 'id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $his->datetime = date('Y-m-d H:i:s');
        $his->save();  
        return redirect()->route('bikerental.index')->with('success', 'อัพเดทเรียบร้อย');
    }
    ...
    {   
        ...
        $status->save(); 
        $user->delete();
        return redirect()->route('bikerental.index')->with('success', 'ลบข้อมูลเรียบร้อย');
    }
}
