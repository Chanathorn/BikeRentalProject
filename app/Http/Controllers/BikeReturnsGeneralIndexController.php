...
class BikeReturnsGeneralIndexController extends Controller
{
    ...
    {   
        ...
        ->paginate(6);
        //dd($details);
        return view('alluser\bikereturnindex1.index', compact('user1','details'));
    }
    ...
    {    
        ...
        //dd($user1);
        return view('alluser\bikereturnindex1.create', ['user'=>$user ,'user1' =>$user1]);
