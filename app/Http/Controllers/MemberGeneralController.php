...
class MemberGeneralController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($users);
        return view('alluser\member1.index', compact('details','user1'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $his->save();  
        return redirect('/home/member')->with('success', 'บันทึกข้อมูลเรียบร้อย');
    }
    ...
    {   
       ...
       // $user->member_id = $request->get('member_id');
        ...
        $his->datetime = date('Y-m-d H:i:s');
        $his->save();  
        return redirect('/home/member')->with('success', 'อัพเดทเรียบร้อย');
    }
    ...
    public function destroy($id)
    {
        ...
        $user = Member::find($id);
        $user->delete();
        return redirect('/home/member')->with('success', 'ลบข้อมูลเรียบร้อย');
    }
}
