...
class BikeController extends Controller
{
    public function index()
    {
        ...
        return view('alluser\bike.index', compact('details','details1','details2','user1'));
    }
    public function create()
    {   
        $details = Bikeprice::all();
        return view('alluser\bike.create',compact('details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $his->save(); 
        return redirect()->route('bike.index')->with('success', 'บันทึกข้อมูลเรียบร้อย');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $his->datetime = date('Y-m-d H:i:s');
        $his->save();
        return redirect()->route('bike.index')->with('success', 'อัพเดทเรียบร้อย');
    }
    public function destroy($id)
    {
        ...
        $user = Bike::find($id);
        $user->delete();
        return redirect()->route('bike.index')->with('success', 'ลบข้อมูลเรียบร้อย');
    }
}
